...
2. **Generation Agents** 🎨
   - Leverages `imagen-4.0-fast-generate-001` via the `google-genai` SDK to produce the core variations of the seed imagery.
...
4. **Labeling Agent** 🏷️
   - Powered by `gemini-3.5-flash` (or equivalent multi-modal LLM).
...
- **Vision Models**: Imagen 4.0 (Generation)
- **LLM/VLM Models**: Gemini 2.5 Flash / Gemini 3.5 Flash (Labeling & Orchestration)
